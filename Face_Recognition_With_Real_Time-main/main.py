...
while True:
    ...
    if faceCurFrame:
        ...
        if counter != 0:
            ...
            if modeType == 1:
                if counter <= 35:  # Extended time for Mode 1 (student info)
                    modeType = 1
                elif counter <= 45:  # Show Mode 2 (Marked) for a shorter time
                    modeType = 2
            ...
            if modeType != 3:
                if counter <= 35:  # Show student info during Mode 1
                ...
                if counter >= 45:  # After Mode 2, transition to Mode 3
                    counter = 0
                    studentInfo = []
                    imgStudent = []
                    modeType = 3
